...
ActiveRecord::Schema[7.0].define(version: 2023_07_25_154725) do
  ...
  create_table "tenant_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["discarded_at"], name: "index_tenant_users_on_discarded_at"
    t.index ["tenant_id"], name: "index_tenant_users_on_tenant_id"
    t.index ["user_id", "tenant_id"], name: "index_tenant_users_on_user_id_and_tenant_id", unique: true
